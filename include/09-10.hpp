    ...
    public:
        ...
        */
        void setColor(SDL_Color __color) {
            SDL_SetTextureColorMod(this->texture, __color.r, __color.g, __color.b);
        }
        ...
        */
        void setBlendMode(SDL_BlendMode __blending) {
            SDL_SetTextureBlendMode(this->texture, __blending);
        }
        ...
        */
        void setAlpha(Uint8 __alpha) { 
            SDL_SetTextureAlphaMod(this->texture, __alpha);
        }
